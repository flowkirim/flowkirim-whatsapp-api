# Flowkirim - WhatsApp Gateway API Gratis Indonesia | Unofficial REST API for Automation 🚀

[![Status](https://img.shields.io/badge/Status-Active-brightgreen.svg)]()
[![Platform](https://img.shields.io/badge/Platform-Web-blue.svg)](https://flowkirim.com)
[![License](https://img.shields.io/badge/License-Free-orange.svg)](https://flowkirim.com)
...
## 💡 Kenapa Memilih Flowkirim?

Banyak developer dan pemilik bisnis kesulitan dengan **WhatsApp Business API Official** karena biaya yang tinggi per pesan dan proses verifikasi yang rumit. Flowkirim hadir sebagai **Alternatif WhatsApp API** yang:

* **100% Gratis:** Tanpa biaya bulanan atau biaya per pesan.
* **Zero Logic Complexity:** Tidak butuh verifikasi Facebook Business Manager.
* **Scalable:** Mendukung multi-device dan unlimited session.
* **Developer Friendly:** REST API standar dengan respon JSON yang cepat.

---

## ✨ Fitur Utama

Sebagai penyedia **WhatsApp Gateway Indonesia**, Flowkirim dilengkapi fitur kelas atas:

* 🚀 **Unlimited Messages:** Kirim & terima pesan tanpa kuota harian.
* 📱 **Multi-Device Support:** Hubungkan banyak nomor WhatsApp dalam satu akun.
* ⚡ **Real-time Webhook:** Terima pesan masuk secara instan ke server Anda.
* 📢 **Broadcast & Blast:** Kirim pesan massal untuk kebutuhan marketing.
* 📅 **Scheduled Messaging:** Atur jadwal pengiriman pesan secara otomatis.
* 🔍 **Google Maps Scraper:** Cari lead/prospek nomor WhatsApp langsung dari Google Maps.
* 📊 **Analytics Dashboard:** Pantau status pesan (Sent, Delivered, Read) secara mendetail.

---

## 🔌 Integrasi & Teknologi

Flowkirim mendukung berbagai bahasa pemrograman dan tools otomasi:

* **RESTful API:** Integrasi mudah dengan **PHP, Laravel, Node.js, Python, Go, Java**.
* **No-Code Tools:** Support penuh untuk **n8n, Zapier, Make.com**, dan **Pabbly**.
* **JSON Response:** Format data standar yang mudah di-parsing.
* **Custom Webhook URL:** Teruskan data pesan masuk ke endpoint URL Anda sendiri.
